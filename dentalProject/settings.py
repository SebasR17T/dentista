...
SECRET_KEY = 'django-insecure-zyq=kfm2t0k(a%a6%j=u2*@bi86h@gc&80@0)av#swvpc@gj17'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'dentalApp/templates/dentalApp'],  # Asegúrate de que esto esté correcto
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
X_FRAME_OPTIONS = 'SAMEORIGIN'  # Ensure this line is present
SILENCED_SYSTEM_CHECKS = ['security.W019']  # Ensure this line is present
